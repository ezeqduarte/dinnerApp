function App() {
  return (
    <div className="font-spartan">
      <header className="w-screen text-white h-[90vh] bg-[url('/images/homepage/hero-bg-desktop@2x.jpg')] bg-cover">
        <div className="container flex flex-col py-[1rem] h-full mx-auto">
          ...
          <div className="flex flex-col gap-5 justify-center w-[35rem] items-start grow">
